...
// Note: In a real app, ensure API key is available. 
// If missing, we return a mock response to prevent crash if user hasn't set env var in this demo environment.
